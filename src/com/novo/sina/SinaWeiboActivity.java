...
public class SinaWeiboActivity extends Activity implements IWeiboHandler.Response, SocialInterface, OnClickListener{	
	...
	private void initButton(){
		...
		m_shareButton = (Button)findViewById(R.id.sina_share_button);
	...
	public boolean initSDK() {
		// TODO Auto-generated method stub
		m_Weibo = new WeiboAuth(this, new SinaConfig().getAPP_KEY(), new SinaConfig().getREDIRECT_URL(), new SinaConfig().getSCOPE());
		if(null == m_Weibo)
		{
		...
		{
			m_iWeiboApi.registerWeiboDownloadListener(new IWeiboDownloadListener(){

				@Override
				public void onCancel() {
					// TODO Auto-generated method stub
					DebugUtil.TostShow(SinaWeiboActivity.this, "用户取消下载");
				}
